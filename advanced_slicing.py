...
# Problem Statement: You have a list of daily temperatures for one month, and you'd like to extract specific 
# data from it.
...
temperatures = [72, 75, 78, 79, 80, 81, 82, 83, 85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 97,
...
print("Temperetures over 100:", temperatures_over_100)
