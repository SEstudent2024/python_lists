...
# Problem Statement: You have two lists of student names. One list contains the names of students who 
# have submitted their assignments, and the other list contains the names of students who attended the last class.
...
if "Alice" in submitted and "Alice" in attended:
    ...
    print("Alice did not submit her assignment or attended the class.")